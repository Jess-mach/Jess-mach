...
API para tópicos, respostas e usuários com autenticação JWT, paginação e migrações Flyway.
...
└── com.jess.forumhub/
    ...
    └── security
```
> Pacote base sugerido: **com.jess.forumhub**
...
docker build -t forum-hub-api:latest .
docker run -p 8080:8080 --env-file .env forum-hub-api:latest
```
