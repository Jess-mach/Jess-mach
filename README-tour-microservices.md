...
Conjunto de microserviços para reservas de passeios (gateway + serviços).
...
└── com.jess.tour/
    ...
    └── security
```
> Pacote base sugerido: **com.jess.tour**
...
docker build -t tour-booking-microservices:latest .
docker run -p 8080:8080 --env-file .env tour-booking-microservices:latest
```
