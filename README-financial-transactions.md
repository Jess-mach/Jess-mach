...
Registros e validações de transações financeiras com regras de negócio e tratamento de erros.
...
└── com.jess.finance/
    ...
    └── security
```
> Pacote base sugerido: **com.jess.finance**
...
docker build -t financial-transactions-api:latest .
docker run -p 8080:8080 --env-file .env financial-transactions-api:latest
```
